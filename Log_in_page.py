...
class LoginPage:
    ...
    def __init__(self, window):
        ...
        self.quote_label = Label(
            self.window,
            text=" Your Lifetime Financial Partner",
            bg="#312c3c",
            fg="#6D54B5",
        )
        ...
        self.password_wrong_label = Label(
            self.lgn_frame,
        ...
        normal_font2 = font.Font(
            family="Bahnschrift SemiLight", size=14, weight="bold", underline=0
        )
        hover_font2 = font.Font(
            family="Bahnschrift SemiLight", size=14, weight="bold", underline=1
        )
        ...
        # ----------------- login Button -----------------
        self.log_in_bg = Label(
            self.lgn_frame, bg="#312c3c", fg="white", image=self.box_btn
        )
        self.log_in_bg.image = self.box_btn
        self.log_in_bg.place(x=70, y=320)
        self.log_in_btn = Button(
            self.lgn_frame,
            text="Log In",
            bg="#6D54B5",
            activebackground="#6D54B5",
            activeforeground="#0C0D0D",
            fg="white",
            font=("Segoe UI", 16, "bold"),
            bd=0,
            command=self.all_check,
        )
        self.log_in_btn.place(x=240, y=328, width=100, height=30)
        # ------------------sub sublogin labels-----------------
        self.forget_pass = Button(
            self.lgn_frame,
            text="Forgotten password?",
            bg="#312c3c",
            fg="#BAB9B9",
            bd=0,
            activebackground="#312c3c",
            activeforeground="#BAB9B9",
            cursor="hand2",
            font=("Bahnschrift SemiLight", 14, "bold"),
            command=self.go_forget_pass_page,
        )
        self.forget_pass.place(x=180, y=374)
        self.username_line = Canvas(
            self.lgn_frame, width=525, height=2.0, bg="#980398", highlightthickness=0
        )
        ...
        self.signup_label = Label(
            ...
            bg="#312c3c",
            fg="#ffffff",
            font=("Bahnschrift SemiLight", 15, "bold"),
        )
