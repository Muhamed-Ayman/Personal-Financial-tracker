...
class OTPPage:
    def __init__(self, window, username=None, password=None):
        ...
        self.dollar_bag_sign_label = Label(
            self.lgn_frame, image=self.dollar_bag_sign, bg="#2d2638"
        )
        self.dollar_bag_sign_label.image = self.dollar_bag_sign
        self.dollar_bag_sign_label.place(x=98, y=190)
        self.quote_label1 = Label(
            self.lgn_frame, text="Security &", bg="#2d2638", fg="#6D54B5"
        )
        self.quote_label1.config(font=("Forte", 43, "bold"))
        self.quote_label1.place(x=13, y=357)
        self.quote_label2 = Label(
            self.lgn_frame, text="privacy are", bg="#2d2638", fg="#6D54B5"
        )
        self.quote_label2.config(font=("Forte", 42, "bold"))
        self.quote_label2.place(x=13, y=430)
        self.quote_label2 = Label(
            self.lgn_frame, text="our top priorities.", bg="#2d2638", fg="#6D54B5"
        )
        ...
        img33 = Image.open(resource_path("images/email_bg_img.png"))
        img33 = img33.resize((400, 65), Image.Resampling.LANCZOS)
        self.email_bg_img = ImageTk.PhotoImage(img33)
        img35 = Image.open(resource_path("images/email_bg_img_active.png"))
        ...
        self.note = Label(
            self.lgn_frame, text="•", font=("Arial", 22, "bold"), bg="#ffffff"
        )
        self.note.place(x=600, y=96)
        self.note = Label(
            self.lgn_frame,
            text="Enter your email to confirm your account.",
        ...
        self.email_wrong_label2 = Label(
            self.lgn_frame,
            text="Email is used before",
            bg="#ffffff",
            font=("OCR A Extended", 11),
            fg="red",
            width=0,
        ...
        self.email_verify_button = Button(
            self.lgn_frame,
            text="Verify",
            font=("Berlin Sans FB Demi", 19, "bold"),
            bd=0,
            bg="#ffffff",
            fg="#05497d",
        ...
        self.note2_opt1 = Label(
            self.otp_frame,
            text=" we’ve sent a 6-digit verification code to your email. Enter the code below to confirm and continue setting up your account",
            font=("Agency FB", 13),
            bg="#ffffff",
            fg="#000000",
            heigh=0,
        ...
        self.note2_opt1 = Label(
            self.otp_frame,
            text="If you don’t see it, check your spam or junk folder—it may take a moment to arrive",
            font=("Agency FB", 13),
            bg="#ffffff",
            fg="#000000",
            heigh=0,
        ...
        self.otp_bg_label_act = Label(
            self.otp_frame, bg="#ffffff", image=self.otp_bg_act
        )
        ...
        self.reverify = Label(
            self.otp_frame,
            text="veriy your account again",
            font=("OCR A Extended", 16, "underline"),
            bg="#ffffff",
            fg="#3B2F32",
            heigh=0,
            cursor="hand2",
    ...
    def create_widgets(self):
        ...
        for i in range(6):
            otp_bg = Label(
                self.otp_frame, image=self.otp_bg, bg="#ffffff", width=70, height=75
            )
            ...
            entry.place(
                x=otp_x_start + (i * 97) + 10, y=otp_y + 10, width=50, height=55
            )
