...
class signPage:
    ...
    def __init__(self, window):
        ...
        self.username_wrong_label2 = Label(
            self.lgn_frame,
            text="Empty field",
            bg="#ffffff",
            fg="red",
        ...
        self.password_instructions1 = Label(
            self.lgn_frame,
            text=password_instructions[0],
            bg="#ffffff",
            fg="#A3A3A3",
            font=self.inst_font,
        )
        self.password_instructions1.place(x=600, y=335)
        self.password_instructions2 = Label(
            self.lgn_frame,
            text=password_instructions[1],
            bg="#ffffff",
            fg="#A3A3A3",
            font=self.inst_font,
        )
        self.password_instructions2.place(x=600, y=360)
        self.password_instructions3 = Label(
            self.lgn_frame,
            text=password_instructions[2],
            bg="#ffffff",
            fg="#A3A3A3",
            font=self.inst_font,
        )
        self.password_instructions3.place(x=870, y=335)
        self.password_instructions4 = Label(
            self.lgn_frame,
            text=password_instructions[3],
            bg="#ffffff",
            fg="#A3A3A3",
            font=self.inst_font,
        )
        ...
        self.und_line4 = Canvas(
            self.lgn_frame, width=550, height=1.5, bg="#d0d0d0", highlightthickness=0
        )
        self.und_line4.place(x=597, y=460)

        self.confirm_wrong_label = Label(
            self.lgn_frame,
        ...
        self.continue_button = Button(
            ...
            activebackground="#ffffff",
            borderwidth=0,
            command=self.all_chreditials_page1,
        )
    ...
    def Passfunc(self):
        ...
        if (
            len(pas) >= 8
            and any(char.isupper() for char in pas)
            and any(char.isdigit() for char in pas)
            and any(not char.isalnum() for char in pas)
        ):
            self.pass_wrong_label.place_forget()
            return True
        else:
    ...
    def all_chreditials_page1(self):
        if (
            ...
            or self.password.get() == "Password"
            or self.confirmpassword.get() == "Confirm password"
        ):
